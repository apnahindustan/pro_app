...
async function fetchUserData(username) {
    try {
        const response = await fetch('https://script.google.com/macros/s/AKfycbwo8n5mlIb2DpudOzn2tg1-5gjeuNTFbg51fuMLGksd3JEvD1CA_h-SjwC7YySFMnZKFQ/exec?username=' + username);
